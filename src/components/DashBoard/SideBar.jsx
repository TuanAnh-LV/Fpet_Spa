...
const Sidebar = () => {
  ...
  const toggleBookingDropdown = () => setShowBookingDropdown(!showBookingDropdown);
  ...
  return (
    <div className={`min-h-screen my-4 ml-4 bg-[#FFFFFF] border rounded-xl ${isCollapsed ? "w-16" : "w-[286px]"} transition-all duration-300`}>
      <div className="flex justify-between items-center p-4 font-bold text-lg border-b">
        {isCollapsed ? (
          <span className="text-gray-700 cursor-pointer" onClick={toggleSidebar}>☰</span>
        ) : (
          <>
