...
const CartItem = () => {
  const {
    ...
    removeFromCart,
    addToCart,
    refreshCart, // Use refreshCart from context
    products,
                    ...
                    <tbody>
                      {cartProducts.map((product) => (
                        <tr key={product.productId}>
                          ...
                          <td className="py-4">
                            <div className="flex items-center">
                              <button
                                ...
                                onClick={() => addToCart(product.productId, -1).then(handleCartItemUpdate)}
                          ...
                          <td className="py-4">
                            <DeleteIcon className="cursor-pointer" onClick={() => removeFromCart(product.productId).then(handleCartItemUpdate)} />
                          </td>
                        </tr>
                      ))}
                    </tbody>
